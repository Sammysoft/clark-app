                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-0 sh-9 mb-3">
                          <div class="col-auto">
                            <img
                              ...
                              class="card-img rounded-md h-100 sw-13"
                              alt="thumb"
                            />
                          </div>
                          <div class="col">
                      ...
                      <div>
                        <div class="row g-0 mb-2">
                          <div class="col-auto ms-auto ps-3 text-muted">
                            Total
                          </div>
                        ...
                        <div class="d-flex flex-column justify-content-start">
                          <div class="d-flex flex-column">
                            ...
                            <div class="text-muted mt-1">
                              Biscuit donut powder sugar plum pastry. Chupa
                      ...
                      <div class="h-100">
                        <div class="d-flex flex-column justify-content-start">
                          <div class="d-flex flex-column">
                            ...
                            <div class="text-muted mt-1">
                              Apple pie cotton candy tiramisu biscuit cake
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col">
                      <div class="h-100">
                        <div class="d-flex flex-column justify-content-start">
                          <div class="d-flex flex-column">
                            <a href="#" class="heading stretched-link pt-0">
                              Delivered
                            </a>
