              ...
              <div class="card mb-2 bg-transparent no-shadow d-none d-md-block">
                <div class="card-body pt-0 pb-0 sh-3">
                  <div class="row g-0 h-100 align-content-center">
                    <div class="col-md-2 d-flex align-items-center mb-2 mb-md-0 text-muted text-small">
                      ID
                    </div>
                    <div class="col-md-3 d-flex align-items-center text-muted text-small">
                      NAME
                    </div>
                    <div class="col-md-2 d-flex align-items-center text-muted text-small">
                      PRICE
                    </div>
                    <div class="col-md-2 d-flex align-items-center text-muted text-small">
                      DATE
                  ...
                  <div class="card-body pt-0 pb-0 sh-21 sh-md-8">
                    <div class="row g-0 h-100 align-content-center">
                      ...
                      <div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
                        ...
                        <div class="text-alternate">
                          <span class="badge rounded-pill bg-outline-tertiary">
                            SHIPPED
                          </span>
                        </div>
                      </div>
