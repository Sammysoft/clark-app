...
import MyStore from "../Components/StoreFront/MyStore";
import MyStoreDetail from "../Components/StoreFront/MyStoreDetail";
import Settings from "../Components/Settings";

const DashboardPage = () => {
  const { _setUser, _getUser } = useContext(AuthContext);
  useEffect(() => {
  ...
  const thisRoute = searchParams.get("screen");
  const [route, setRoute] = useState(`${thisRoute}`);
  useEffect(() => {
    setRoute(`${thisRoute}`);
  }, [route]);
  ...
  switch (route) {
    case "products":
      return (
        <div>
          ...
          <ProductListPage route={route} setRoute={setRoute} />
        </div>
      );
      break;
    ...
    case "add-product":
      return (
        <div>
          <SideBar route={route} setRoute={setRoute} />
          <AddNewProduct route={route} setRoute={setRoute} />
        </div>
      );
      break;
    case "orders":
      return (
        <div>
          <SideBar route={route} setRoute={setRoute} />
          <OrderListPage route={route} setRoute={setRoute} />
        </div>
      );
      break;
    case "order-details":
      return (
        <div>
          <SideBar route={route} setRoute={setRoute} />
          <OrderDetailsPage route={route} setRoute={setRoute} />
        </div>
      );
      break;
    case "my-store":
      return (
        <div>
          <SideBar route={route} setRoute={setRoute} />
          <MyStore route={route} setRoute={setRoute} />
        </div>
      );
      break;
      case "settings":
        return (
          <div>
            <SideBar route={route} setRoute={setRoute} />
            <Settings route={route} setRoute={setRoute} />
          </div>
        );
        break;
    case "my-store-detail":
      return (
        <div>
          <SideBar route={route} setRoute={setRoute} />
          <MyStoreDetail route={route} setRoute={setRoute} />
        </div>
      );
      break;
    default:
                    ...
                    <div class="page-title-container">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-7">
                          <a
                            class="muted-link pb-2 d-inline-block hidden"
                            href="#"
                          >
                            <span class="align-middle lh-1 text-small">
                              &nbsp;
                            </span>
                          </a>
                          <h1 class="mb-0 pb-0 display-4" id="title">
                            Welcome, {_getUser?.profile?.full_name}!
                          </h1>
                        </div>
                        {/* <!-- Title End --> */}
                      </div>
                            ...
                            <div class="card mb-2 sh-15 sh-md-6">
                              <div class="card-body pt-0 pb-0 h-100">
                                <div class="row g-0 h-100 align-content-center">
                                  ...
                                  <div class="col-2 col-md-3 d-flex align-items-center text-muted mb-1 mb-md-0 justify-content-end justify-content-md-start">
                                    <span class="badge bg-outline-quaternary me-1">
                                      DELIVERED
                                    </span>
                                  </div>
                                  <div class="col-12 col-md-2 d-flex align-items-center mb-1 mb-md-0 text-alternate">
                          ...
                          <div class="card-body h-100">
                            <div class="h-100">
                              ...
                              <div class="custom-tooltip position-absolute bg-foreground rounded-md border border-separator pe-none p-3 d-flex z-index-1 align-items-center opacity-0 basic-transform-transition">
                                ...
                                <div>
                                  <span class="text d-flex align-middle text-alternate align-items-center text-small">
                                    Bread
                                  </span>
                                  <span class="value d-flex align-middle text-body align-items-center cta-4">
                                    300
                                  </span>
                                </div>
                              </div>
                                  ...
                                  <div class="row g-0 sh-10 mb-3">
                                    <div class="col-auto">
                                      <a href="Products.Detail.html">
                                        <img
                                          src="img/product/small/product-2.webp"
                                          class="card-img rounded-md h-100 sw-8"
                                          alt="thumb"
                                        />
                                      </a>
                                    </div>
                                      ...
                                      <div class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
                                        <div class="d-flex flex-column">
                                          ...
                                          <div class="text-small text-muted text-truncate mb-1">
                                            Chocolate bar marzipan marzipan
                                            carrot cake gingerbread pastry ice
                                            cream. Ice cream danish sugar plum
                                            biscuit pudding powder soufflé donut
                                            macaroon.
                                          </div>
                                    ...
                                    <div class="col">
                                      <div class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
                                        <div class="d-flex flex-column">
                                          ...
                                          <div class="text-small text-muted text-truncate mb-1">
                                            Bear claw sweet liquorice jujubes.
                                            Muffin gingerbread bear claw.
                                          </div>
                                          <div class="br-wrapper br-theme-cs-icon">
                                            <select
                                              class="rating"
                            ...
                            <div class="col-12 d-flex flex-column justify-content-between align-items-start">
                              <div>
                                ...
                                <div class="text-muted mb-4">
                                  Cheesecake chocolate carrot cake pie lollipop
                                  apple pie lemon cream lollipop.
                                  <br />
