            ...
            <div class="col-12 col-xl-9 mb-5">
              <div class="row g-2 mb-2">
                <div class="col-12 col-sm-6 col-md-8">
                  <div class="card sh-30 sh-sm-45 hover-img-scale-up">
                    ...
                    <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                      <div>
                        <div class="cta-1 mb-3 text-black w-md-100 w-75">
                          Wall Shelf Ideas to Transform Your Space
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                  <div class="card sh-30 sh-sm-45 hover-img-scale-up">
                    <img
                      src="img/banner/cta-vertical-3.webp"
                      class="card-img h-100 scale"
                      alt="card image"
                    />
                    <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                      <div>
                        <div class="cta-1 mb-5 text-black w-md-100 w-75">
                          Sale on Notebooks and Sketchbooks
                        </div>
                      </div>
                      <div>
                        <a
              ...
              <div class="row g-2">
                <div class="col-12 col-sm-6">
                  <div class="card sh-22 sh-xl-19 hover-img-scale-up">
                    <span class="badge rounded-pill bg-primary me-1 position-absolute e-2 t-2 z-index-1">
                      SALE
                    </span>
                    <img
                      src="img/banner/cta-horizontal-short-1.webp"
                      class="card-img h-100 scale"
                      alt="card image"
                    />
                    <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                      <div>
                        <div class="cta-3 mb-2 text-black w-75">
                          10% Discount for Canned Products
                        </div>
                      </div>
                      <div>
                        <a
                ...
                <div class="col-12 col-sm-6">
                  <div class="card sh-22 sh-xl-19 hover-img-scale-up">
                    ...
                    <img
                      src="img/banner/cta-horizontal-short-2.webp"
                      class="card-img h-100 scale"
                      alt="card image"
                    />
                    <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 g-2 mb-5">
            <div class="col">
              <div class="card h-100">
                <span class="badge rounded-pill bg-primary me-1 position-absolute s-n2 t-2 z-index-1">
                  SALE
                </span>
                <img
                ...
                <div class="card-body pb-2">
                  <div class="h6 mb-0 d-flex">
                    <a
                      ...
                      class="body-link d-block lh-1-25 stretched-link"
                    >
                      <span class="clamp-line sh-4" data-line="2">
                        Wooden Animal Toys
                      </span>
                    </a>
                  </div>
              ...
              <div class="card h-100">
                ...
                <div class="card-body pb-3">
                  <h5 class="heading mb-0 d-flex">
                    <a
                      href="Storefront.Detail.html"
                      class="body-link d-block lh-1-5 stretched-link"
                    >
                      <span class="clamp-line sh-4" data-line="2">
                        Modern Dark Pot
                      </span>
                ...
                <div class="row g-0 sh-16 sh-sm-17">
                  <div class="col-auto h-100 position-relative">
                    ...
                    <img
                      ...
                      alt="alternate text"
                      class="card-img card-img-horizontal h-100 sw-11 sw-sm-16 sw-lg-20"
                    />
                  </div>
                  <div class="col p-0">
                    <div class="card-body d-flex align-items-center h-100 py-3">
                      <div class="mb-0 h6">
                        ...
                        >
                          <div class="clamp-line sh-3 lh-1-5" data-line="1">
                            XBox Controller
                          </div>
                        </a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div
                  id="categoryMenuMoveContent"
                  data-move-target="#menuColumn"
                  data-move-breakpoint="xl"
                >
                  <a
                    class="nav-link body-link px-0 py-2"
                    href="Storefront.Categories.html"
                  >
                    ...
                    <i
                      ...
                      class="align-middle float-end mb-1"
                      data-acorn-size="13"
                    ></i>
                  </a>
                  <a
